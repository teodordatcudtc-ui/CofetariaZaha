      ...
      <div className="container-custom py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            ...
            Cofetăria Zaha București. Prin utilizarea serviciilor noastre, acceptați 
          ...
          <h2>6. Contact</h2>
          <p>
            Pentru întrebări privind acești termeni și condiții, vă rugăm să ne 
            contactați la: 0731 195 126 sau la adresa: Șoseaua Ștefan cel Mare 12, București.
          </p>
        </div>
      </div>
    </div>
